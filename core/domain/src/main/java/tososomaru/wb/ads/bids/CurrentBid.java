...
public class CurrentBid {
    ...
    public CurrentBid(Integer rank, Integer itemNumber, Integer position, Integer page, Integer cpm, Integer deliveryTime, Integer categoryId) {
        this.rank = rank;
    ...
    private static String buildPreviewLink(Integer itemNumber) {
        ...
        return String.format(
                ...
                itemNumberStr.substring(0, itemNumberStr.length() - 4),
                itemNumber
        );
    }

    public BidPreview toPreview() {
        return new BidPreview(
                cpm,
                itemNumber,
                rank,
                previewLink
